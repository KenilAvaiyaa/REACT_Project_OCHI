...
const Footer = () => {
  return (
    <div data-scroll data-scroll-seaction data-scroll-speed="-0.05" className="w-full h-screen px-10 py-20 rounded-tl-3xl rounded-tr-3xl">
      <div className="w-full h-full flex">
        <div className=" w-1/2 h-full flex flex-col items-start justify-between">
          <h1 className=" w-1/4 uppercase font-[head] leading-[6.5vw] text-[8.8vw]">
            Eye-OPENING
          </h1>
          <svg
            width="72"
        ...
        <div className=" w-1/2 h-full">
          <h1 className=" uppercase font-[head] leading-[6.5vw] text-[8.8vw]">
            PRESENTATIONS
          </h1>
          <h1 className=" flex flex-col font-[nev] font-[200] text-base">
            <h1 className=" w-1/2 mt-10 font-[nev] font-[200] text-lg mb-4">
              S:
            </h1>
            <a href="#">Instagram</a>
            <a href="#">Behance</a>
          ...
          <div className="w-full flex mt-5 ">
            <div className="w-3/4">
              <h1 className="  flex flex-col font-[nev] font-[200] text-base">
                <h1 className=" font-[nev] font-[200] text-lg mb-4">L:</h1>
                <h4 className="">202-1965 W 4th </h4>
                <h4 className="">AveVancouver, Canada </h4>
                <h4 className="mt-5">30 Chukarina </h4>
                <h4 className="">StLviv, Ukraine </h4>
              </h1>
            </div>
            <div className="w-1/4">
              <h1 className=" flex flex-col font-[nev] capitalize font-[200] text-base">
                <h1 className="  font-[nev]  font-[200] text-lg mb-4">M:</h1>
                <a href="#">home</a>
                <a href="#">services</a>
                <a href="#">our work</a>
                <a href="#">about us</a>
          ...
          <h1 className=" w-1/2 mt-3 font-[nev] font-[200] text-lg mb-4">E:</h1>
          <a href="#">hello@ochi.design</a>

          <div className=" w-full flex justify-between">
            <h1 className=" font-[nev] mt-20 font-[100] text-[#B9B9B9] text-lg mb-4">
